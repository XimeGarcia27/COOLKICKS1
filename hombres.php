    ...
    <main>
        <section id="catalogo">
            <div class="contenedor">
                ...
                <article class="mov">
                    <img src="assets/img/<?php print($temp[1]['imagen']);?>">
                    <h3><?php print  $temp[1]['nombre'];?></h3>
                    <p><?php print "$". $temp[1]['precio'];?></p>
                </article>

                <article class="mov">
                    <img src="assets/img/<?php print($temp[2]['imagen']);?>">
                ...
                <article class="mov">
                    <img src="assets/img/<?php print($temp[12]['imagen']);?>">
                    <h3><?php print  $temp[12]['nombre'];?></h3>
                    <p><?php print "$". $temp[12]['precio'];?></p>
                </article>

                <article class="mov">
                    <img src="assets/img/<?php print($temp[13]['imagen']);?>">
                    <h3><?php print  $temp[13]['nombre'];?></h3>
                    <p><?php print "$". $temp[13]['precio'];?></p>
                </article>

                <article class="mov">
                    <img src="assets/img/<?php print($temp[14]['imagen']);?>">
                    <h3><?php print  $temp[14]['nombre'];?></h3>
                    <p><?php print "$". $temp[14]['precio'];?></p>
                </article>
